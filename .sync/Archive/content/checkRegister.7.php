...
$password = hash('sha512', $password);
 if($universityRole == 'Student'){
    query("INSERT into `user` (`User_ID`, `Forename`, `Surname`, `DoB`, `Email_Address`, `Phone`, `Is_Student`, `Is_Lecturer`, `Is_Other_Staff`, `UP_Number`, `password`) values('','$forename','$surname','$dateOfBirth','$email','$phoneNumber',TRUE ,FALSE ,FALSE ,'$UPnumber','$password');");
    //popUpCorrect("You been succesfully added");
}
else if($universityRole == "Lecturer"){
    query("INSERT into `user` (`User_ID`, `Forename`, `Surname`, `DoB`, `Email_Address`, `Phone`, `Is_Student`, `Is_Lecturer`, `Is_Other_Staff`, `UP_Number`, `password`) values('','$forename','$surname','$dateOfBirth','$email','$phoneNumber',FALSE ,TRUE ,FALSE ,'$UPnumber','$password');");
}
else if($universityRole == "Other"){
